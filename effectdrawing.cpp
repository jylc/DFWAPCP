	...
	img_data_ptr(_img_data_ptr)
{
	...
	cv::Mat middle_img = img_data_ptr->getIntersectedImg(img_data_ptr->getOptimizedStereoImg(), 0);
	cv::Mat stereo_img = img_data_ptr->getIntersectedImg(img_data_ptr->getStereoImg(), 0);
